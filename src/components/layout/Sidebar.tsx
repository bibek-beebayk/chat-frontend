...
export function Sidebar({ onClose }: { onClose?: () => void }) {
    ...
    const showStaffOnlyLinks = !isRoleLoading && isStaff;
    ...
    // The new player-only dashboard's nav (see PlayerHomePage) - kept
    // separate from agentNavGroups below so agent's sidebar is untouched.
    const newPlayerNavGroups: NavGroup[] = [
        {
            title: 'PLAY',
            items: [
                homeItem,
                { href: '/games', label: 'Games', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="6" width="20" height="12" rx="2" ry="2"></rect><path d="M12 12h.01M16 12h.01M8 12h.01"></path></svg> },
                { href: '/challenges', label: 'Challenges', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9 11l3 3L22 4"></path><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"></path></svg> },
                ...
                { href: '/leaderboards', label: 'Leaderboard', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 20v-6M6 20V10M18 20V4"></path></svg> },
            ]
        },
        {
            title: 'COMMUNITY',
            items: [
                { href: '/posts', label: 'Feed', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg> },
                chatItem,
                { href: '/connections', label: 'Players', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg> },
        ...
        },
        {
            ...
            items: [
                faqItem,
                { href: '/guidelines', label: 'Community Guidelines', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg> },
                downloadItem,
            ]
        },
    ];
    ...
    const navGroups = isRoleLoading ? [] : showStaffOnlyLinks ? staffNavGroups : isPlayer ? newPlayerNavGroups : agentNavGroups;
