    ...
    const navGroups = [
        {
            ...
            items: [
                ...
                { href: '/chat', label: 'Community Chat', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>, badge: '12' },
    ...
    return (
        <div className={styles.sidebar}>
            ...
            <div className={styles.sidebarFooter}>
                <button className={styles.themeToggle} onClick={() => setThemeMode(themeMode === 'dark' ? 'light' : 'dark')}>
